...
document.querySelector('.popup__button_card').addEventListener('click', function (event) {
...
document.querySelector('.popup__button_info').addEventListener('click', function (event) {
  event.preventDefault();
...
const validateFormAvatar = new FormValidator(formAvatar);
...
document.querySelector('.popup__button_avatar').addEventListener('click', function (event) {
  event.preventDefault();
